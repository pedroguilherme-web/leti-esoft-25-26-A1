...
|:-------------  |:------------------------------------------------|:-------------------------|:------------------------------|
| Step 1  		 | Showing the available roles							              | GetEmployeeListView      |                               |
| Step 2  		 | Showing the employee list depending on the type | GetEmployeeListController |                |
| Step 3  		 | Getting the nurse list							                   | NurseContainer           |                               |
| Step 4  		 | Geting the receptionist list 							            | ReceptionistContainer    |                               |
